...
with open('input/03.txt') as f:
    ...
    oxigenGeneratorRate = int(filterLines(lines.copy(),0),2)
    CO2ScrubberRate = int(filterLines(lines.copy(),1),2)
    print(f'The life support rating of the submarine {oxigenGeneratorRate*CO2ScrubberRate}')